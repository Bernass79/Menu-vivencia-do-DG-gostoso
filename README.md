...
local Window = Rayfield:CreateWindow({
    Name = "🔥 WAVE-menu Menu Vivencia parana 🔥",
...
local isMouseButton2Down = false -- Nova variável para rastrear M2
...
ServiceConnections.MouseButton2Up = UserInputService.InputEnded:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton2 then
        ...
        CancelLock() -- Cancela o lock quando soltar M2
    end
end)
...
local function Load()
    ServiceConnections.RenderSteppedConnection = RunService.RenderStepped:Connect(function()
        ...
        if aimbotEnabled and Environment.Settings.Enabled and isMouseButton2Down then -- Só ativa aimbot com M2 pressionado
            GetClosestPlayer()
